...
class HBnBFacade:
    ...
    def create_place(self, place_data):
        ...
        data = {k: v for k, v in place_data.items() if k != 'owner_id'}
    ...
    def create_review(self, review_data):
        ...
        data = {k: v for k, v in review_data.items()
                if k not in ('place_id', 'user_id')}
        review = Review(**data, place=place, user=user)
